...
<aside>
I wrote a post on using the `logr` package for logging by analysis on the go. Read it [here](https://sound-reproducible-r.netlify.app/posts/2024-01-09-logr/logr)
</aside>
